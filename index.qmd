...
Late submissions will be accepted but there will be one penalty point deduction for each minute or fraction thereof that your submission is late. In other words, the number of points deducted will be the number of minutes late rounded up to the next minute. Given that each quiz is worth 5 points, this means that if you are more than 5 minutes late you will get 0 points.
